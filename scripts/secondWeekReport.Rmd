...
We will use createDataPartition() to split our training data into two sets : 75% and 25%.

```{r}
# Spliting training set into two parts based on outcome: 75% and 25%
index <- createDataPartition(dataSetTransformed$brand, p = 0.75, list = FALSE)
trainSet <- dataSetTransformed[ index,]
testSet <- dataSetTransformed[-index,]
```
